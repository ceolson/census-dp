ei.MD.bayes <- function(formula, covariate = NULL, total = NULL, data,
                        ...
                        start.list = NULL,
                        sample = 1000,
                        noise_scale = 10, pois_parameter = 500,
                        thin = 1, burnin = 1000, verbose = 0,
                        ret.beta = 'r', ret.mcmc = TRUE,
                        usrfun = NULL, privacy = FALSE){
...
if(is.null(covariate)){
  ...
  if(is.null(usrfun)){
    output <- BayesMDei(formula, data, total=total, lambda1 = lambda1,
                        ...
                        start.betas = start.betas, sample = sample, noise_scale = noise_scale,
                        thin = thin, burnin = burnin, verbose =
                        verbose,
                        ret.beta = ret.beta, ret.mcmc = ret.mcmc, privacy = privacy, pois_parameter = pois_parameter)
